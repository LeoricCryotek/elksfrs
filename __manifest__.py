...
- Year-end closing support with restricted fund accounting
    ...
    "data": [
        ...
        "data/elks_cash_sequences.xml",
        "data/elks_cash_location_data.xml",
        ...
        "views/elks_cash_location_views.xml",
        "views/elks_cash_count_views.xml",
        "views/elks_cash_movement_views.xml",
        "report/cash_count_slip.xml",
        "report/cash_count_meeting_slip.xml",
        "report/change_request_order_slip.xml",
        "report/bank_deposit_slip.xml",
        "report/bag_tag.xml",
        "report/cash_slip_reports.xml",
